    ...
    <div className="w-full h-100% px-4 py-2  focus:outline-none focus:ring focus:border-blue-300 mt-10 min-h-screen bg-[rgb(27,27,27)]">
      ...
      <div className="flex">
        <div className="max-width-80rem ">
          <button
            className="px-4 py-2 rounded-full bg-blue-500 text-white mt-4 text-1xl font-bold "
      ...
      <div className="max-width-80rem mx-auto bg-white rounded-lg overflow-hidden shadow-lg mt-5 bg-[rgb(37,40,42)]">
        ...
        {addresses.length > 0 && (
          <div className="bg-gray-600">
            <h2 className="text-slg font-semibold mb-2 bg-blue-500 text-white p-2 font-bold mb-4 text-2xl font-bold ">
              Resultados{" "}
            </h2>
            ...
            <ul>
              {addresses.map((address, index) => (
                <li key={index} className="pl-4 pr-4">
                  <p className="text-2xl  mb-2 text-white font-bold">
